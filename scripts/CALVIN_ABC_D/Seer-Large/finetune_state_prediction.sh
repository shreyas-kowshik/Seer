...
save_checkpoint_path="checkpoints_state_prediction/"
finetune_from_pretrained_ckpt="/data/user_data/skowshik/checkpoints/Seer_Large_ptbs512_24layers_16heads_hd1024-PT-ep5.pth"
...
node_num=4
torchrun \
    --nnodes=${node} --nproc_per_node=${node_num} --master_port=10212 \
    train.py \
    --traj_cons \
    --rgb_pad 10 \
    --gripper_pad 4 \
