...
python -m torch.distributed.run --nnodes=${node} --nproc_per_node=${node_num} --master_port=10211 eval_libero.py\
    --traj_cons \
    --rgb_pad 10 \
    --gripper_pad 4 \
    ...
    --resume_from_checkpoint /ocean/projects/cis250181p/kowshik/Seer/checkpoints/libero_pretrain_baseline_clip_resnet_action_only_v2/4.pth\
